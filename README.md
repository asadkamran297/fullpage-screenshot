...
The icon is a camera with a down arrow in the lens — camera for screenshot, arrow for the full length of the page. Regenerate the PNG set with `python scripts/make-icons.py` (needs Pillow).
